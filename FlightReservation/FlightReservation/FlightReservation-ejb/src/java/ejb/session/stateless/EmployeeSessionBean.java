...
public class EmployeeSessionBean implements EmployeeSessionBeanRemote, EmployeeSessionBeanLocal {
 @PersistenceContext(unitName = "FlightReservation-ejbPU")
    ...
    public Employee retrieveEmployeeByEmployeeId(Long employeeId) throws EmployeeNotFoundException {
        Employee employeeToRetrieve = em.find(Employee.class, employeeId);
        if(employeeToRetrieve != null){
            return employeeToRetrieve;
        }else{
    ...
    public Employee employeeLogin(String username, String password) throws InvalidLoginCredentialException {
        try {
            Employee employeeToLogin = retrieveEmployeeByUsername(username);
            if(employeeToLogin.getPassword().equals(password)){
